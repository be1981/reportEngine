...
public class AreaChartExporter implements IChartExporter {
	...
	public JFreeChart createChart(Document data) {
		...
		Font catefont = new Font(font, "1".equals(cateElem.attributeValue("isBold"))?Font.BOLD:Font.PLAIN, Integer.parseInt(fontsize));
